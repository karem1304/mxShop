                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h3 class="text-right"><button class="btn btn-primary btn-sm text-right pb-2"> <i class="fas fa-plus"></i>Ajouter</button></h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                        ...
                                        @foreach ($categories as $category)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="#" class="text-success mr-3"> <i class="fas fa-edit"></i></a>
